...
//            public readonly FieldInfo[] Arguments;
...
//                var _method = _type.DefineMethod(Metadata<Routine>.Type.Name, MethodAttributes.Public, CallingConventions.HasThis, Runtime.Void, Type.EmptyTypes).GetILGenerator();
//                if (type == Runtime.Void)
//                {
...
//                    {
//                        if (signature[_index].IsByRef)
//                        {
//                            var _field = _type.DefineField(_index.ToString(), signature[_index].GetElementType(), FieldAttributes.Public);
//                            _constructor.Emit(OpCodes.Ldarg_0);
//                            switch (_index)
//                            {
...
//                            }
//                            if (_field.FieldType.IsValueType) { _constructor.Emit(OpCodes.Ldobj, _field.FieldType); }
//                            else { _constructor.Emit(OpCodes.Ldind_Ref);  }
//                            _constructor.Emit(OpCodes.Stfld, _field);
//                            _method.Emit(OpCodes.Ldarg_0);
//                            _method.Emit(OpCodes.Ldflda, _field);
//                        }
//                        else
//                        {
...
//                    this.Arguments = new FieldInfo[signature.Length];
//                    for (var _index = 0; _index < signature.Length; _index++) { this.Arguments[_index] = this.Type.GetField(_index.ToString()); }
//                }
//                else
//                {
//                    _constructor.Emit(OpCodes.Ldarg_0);
